                ...
                !loading && <div className="fixed top-0 right-0 h-full w-[80%] 800px:w-[25%] bg-white flex flex-col overflow-y-scroll justify-between shadow-sm">
                        ...
                        <div className="w-full h-screen flex items-center justify-center">
                            ...
                            <div className="flex flex-col items-center justify-center">
                                <h5 className="flex justify-center">Your Cart is empty!</h5>
                                <img src="https://w7.pngwing.com/pngs/377/837/png-transparent-empty-cart-illustration-thumbnail.png" alt="" />
                                <Link to='/products'><button className={` flex items-center justify-center  text-white !bg-blue-700 !w-[100px] !h-[30px] rounded-md mt-2`}>View All</button></Link>
                            </div>
                        </div>
                    ) : (
                        <>
